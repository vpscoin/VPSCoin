...
static const int64_t MAX_MINT_PROOF_OF_STAKE = 0.2 * COIN;
...
static const uint256 hashGenesisBlock("0x00000bf1bfd0fcecb7b2890832c2334049688a8df8437581548f2f8c9fb1ded9");
static const uint256 hashGenesisBlockTestNet("0x00000bf1bfd0fcecb7b2890832c2334049688a8df8437581548f2f8c9fb1ded9");
...
public:
    ...
    {
        // VPSCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // VPSCoin: get transaction coin age
...
public:
    ...
    // VPSCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // VPSCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // VPSCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // VPSCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // VPSCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // VPSCoin: block index flags
    enum  
    {
